...
namespace backend.servicios
{
    public static class CarritoCompraServicios
    {
        public static IEnumerable<T> ObtenerTodo<T>()
        {
            ...
            const string storedProcedureName = "select * from CARRITO_COMPRA";
        ...
        public static T ObtenerById<T>(int id)
        {
            ...
            const string storedProcedureName = "select * from CARRITO_COMPRA where ID = @Id and estado_registro = 1";
            var parameters = new DynamicParameters();
            parameters.Add("id", id, DbType.Int64);

            //var result = BDManager.GetInstance.GetDataWithParameters<T>(sql, parameters);
            var result =  BDManager.GetInstance.SPGetDataWithParameters<T>(storedProcedureName, parameters);
        ...
        public static int InsertCarritoCompra(CarritoCompra carritoCompra)
        {
            ...
            const string storedProcedureName = "INSERT INTO [dbo].[CARRITO_COMPRA]([FECHA], [ID_USUARIO]) VALUES (@fecha, @id_usuario) ";
            var parameters = new DynamicParameters();
        ...
        public static int UpdateCarritoCompra(CarritoCompra carritoCompra)
        {
            ...
            const string storedProcedureName = "UPDATE [CARRITO_COMPRA] SET [FECHA] = @fecha, [ID_USUARIO] = @id_usuario WHERE [ID] = @id";
        ...
        public static int DeleteCarritoCompra(int id)
        {
            ...
            const string storedProcedureName = "DELETE FROM [CARRITO_COMPRA] WHERE [ID] = @id";
            var parameter = new DynamicParameters();
